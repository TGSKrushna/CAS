...
export default function DateTimePicker() {
  ...
  return (
    <div
      ...
      style={{ minHeight: 450, marginLeft: "100px" }}
    >
      <div className="col-xs-12 col-md-6 example-col">
        <p>DateInput</p>
        <DateInput value={value} onChange={changeDate} format="MM/dd/yyyy" />
        <p>
          (use <code>←</code> and <code>→</code> to navigate, <code>↑</code> and
          <code>↓</code> to update)
        </p>
        <p>DatePicker</p>
        <DatePicker value={value} onChange={changeDate} format="dd/MM/yyyy" />
        <p>
        ...
        <p>
          (use Alt+<code>↓</code> to open the time list, Tab to move to the next
          time section in the popup, <code>↑</code> to increment and
          <code>↓</code> to decrement the value)
        </p>
      </div>
      <div className="col-xs-12 col-md-6 example-col">
